...
//
// The palettes and the ColorPalette shape now live in `@openclaw/theme`, so
// the desktop and the phone derive the same ~68 tokens from the same ten
// seeds. Re-exported here because the renderer imports them from this module
// in many places, and because ColorPalette is part of its public surface.
import { darkColors, lightColors, type ColorPalette } from '@openclaw/theme'
